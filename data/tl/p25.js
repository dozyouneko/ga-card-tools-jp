...
window.GA_I18N.cards = Object.assign(window.GA_I18N.cards || {}, {
  ...
  "devastating-blow": {
    name: "壊滅の一撃",
    effect:
      "[クラスボーナス] [レベル3以上] 「壊滅の一撃」は+4[パワー]を得て、リタリエイトされない。*（この効果は、あなたのチャンピオンのクラスがこのカードのクラスと一致し、かつあなたのチャンピオンがレベル3以上である場合にのみ適用する。）*",
  },
  ...
  "heavenly-guide": {
    name: "天の導き手",
    effect:
      "[レベル2以上] **登場時：** 対戦相手が、リネージュの一番上にプレイされていないカードが置かれた、スピリットでないチャンピオンをコントロールしている場合、あなたのチャンピオンをレベルアップする。*（あなたのチャンピオンは、あなたのマテリアルデッキから適合するチャンピオンカードにレベルアップする。カードは、起動またはマテリアライズされた場合に「プレイされた」ことになる。）*",
  },
  ...
  "mastermind-scheme": {
    ...
    effect:
      ...
      "あなたのチャンピオンの上にある**プレパレーション**カウンターの数を2倍にする。その後、あなたのチャンピオンに**プレパレーション**カウンターが8個以上ある場合、あなたはこのターン**アジリティ3**を得る。*（アジリティ3 — エンドフェイズの開始時に、あなたのメモリーから3枚を手札に戻す。）*",
  },
  ...
  "shadowstrike": {
    name: "シャドウストライク",
    effect:
      "**プレパレーションX** *（このカードを起動する際、あなたのチャンピオンから**プレパレーション**カウンターをX個取り除いてよい。）* **X**は0にできない。「シャドウストライク」は**+X**[パワー]を得る。\n\n" +
