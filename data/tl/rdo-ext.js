...
window.GA_I18N.cards = Object.assign(window.GA_I18N.cards || {}, {
  ...
  "ariel-archangel-of-natura": {
    name: "アリエル、ナチュラの大天使",
    effect:
      "クラックス＆テラ・インビュー3 *（あなたはこのカードを起動する際、リザーブしたすべてのカードを公開してよい。そのうち少なくとも3枚がクラックスおよび／またはテラエレメントの場合、このカードはインビュー状態になる。）*\n\n" +
  ...
  "azrael-archangel-of-materia": {
    name: "アズラエル、マテリアの大天使",
    effect:
      "エクシア＆ネオス・インビュー3 *（あなたはこのカードを起動する際、リザーブしたすべてのカードを公開してよい。そのうち少なくとも3枚がエクシアおよび／またはネオスエレメントの場合、このカードはインビュー状態になる。）*\n\n" +
  ...
  "haniel-archangel-of-spectra": {
    name: "ハニエル、スペクトラの大天使",
    effect:
      "ラクサム＆アンブラ・インビュー3 *（あなたはこのカードを起動する際、リザーブしたすべてのカードを公開してよい。そのうち少なくとも3枚がラクサムおよび／またはアンブラエレメントの場合、このカードはインビュー状態になる。）*\n\n" +
  ...
  "heartsong-reclamation": {
    name: "ハートソングの奪還",
    effect:
      "あなたがコントロールしていないすべてのレガリアを破壊する。ターン終了時まで、あなたがコントロールする動物および／または獣のアライはクリーヴを得る。\n\n" +
  ...
  "raziel-archangel-of-libra": {
    name: "ラジエル、天秤の大天使",
    effect:
      "アーケイン＆アストラ・インビュー3 *（あなたはこのカードを起動する際、リザーブしたすべてのカードを公開してよい。そのうち少なくとも3枚がアーケインおよび／またはアストラエレメントの場合、このカードはインビュー状態になる。）*\n\n" +
