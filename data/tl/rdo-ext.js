...
window.GA_I18N.cards = Object.assign(window.GA_I18N.cards || {}, {
  ...
  "curtain-of-shadows": {
    name: "影の帳",
    effect:
      "［トリスタンボーナス］「不吉な影」トークンをX体召喚する。Xはあなたのチャンピオン上のプリペアレーションカウンターの数。\n\n" +
      "このゲームの残りの間、あなたがコントロールする「不吉な影」という名前のアライは＋1パワーを得て、「ヒット時：あなたのチャンピオンにプリペアレーションカウンターを1個置く。」を持つ。",
  },
  ...
  "mercenarys-blade": {
    name: "傭兵の刃",
    effect:
      "［クラスボーナス］あなたはあなたのチャンピオンからプリペアレーションカウンターを1個取り除いて、このカードをあなたのマテリアルデッキから起動してよい。*（この効果は、あなたのチャンピオンのクラスがこのカードのクラスと一致する場合のみ適用する。）*",
  },
  ...
  "windwalker-boots": {
    name: "風渡りのブーツ",
    effect:
      "［クラスボーナス］あなたのエンドフェイズの開始時に、あなたのチャンピオンがアウェイクの場合、それにプリペアレーションカウンターを1個置く。\n\n" +
      "「風渡りのブーツ」を追放する：カードを1枚引く。この能力は、あなたのチャンピオン上にプリペアレーションカウンターが5個以上ある場合のみ起動する。",
  },
