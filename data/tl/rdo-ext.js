...
window.GA_I18N.cards = Object.assign(window.GA_I18N.cards || {}, {
  ...
  "angelic-channeling": {
    name: "天使の導き",
    effect:
      "あなたの手札またはメモリーからアドバンスドエレメントのカードを最大3枚追放する。この方法で追放した各カードにつき、カードを1枚あなたのメモリーに引く。このゲームで次にあなたのチャンピオンが基本レベル3のチャンピオンカードにレベルアップしたとき、その追放したカードを好きな順番でデッキの一番上または一番下に置く。\n\nフローティングメモリー",
  },
  ...
  "ariel-archangel-of-natura": {
    name: "アリエル、ナチュラの大天使",
    effect:
      "クラックス＆テラ・インビュー3 *（あなたはこのカードを起動する際、リザーブしたすべてのカードを公開してよい。そのうち少なくとも3枚がクラックスまたはテラエレメントの場合、このカードはインビュー状態になる。）*\n\n" +
  ...
  "auspicious-manifestation": {
    name: "吉兆の顕現",
    effect:
      "［グオ・ジアボーナス］あなたがコントロールする神獣アライを1体追放する。次のエンドフェイズの開始時に、そのアライをトランスフォーム状態でオーナーのコントロール下で戦場に戻す。\n\n" +
  ...
  "azrael-archangel-of-materia": {
    name: "アズラエル、マテリアの大天使",
    effect:
      "エクシア＆ネオス・インビュー3 *（あなたはこのカードを起動する際、リザーブしたすべてのカードを公開してよい。そのうち少なくとも3枚がエクシアまたはネオスエレメントの場合、このカードはインビュー状態になる。）*\n\n" +
  ...
  "crystal-of-argus": {
    name: "アーガスの水晶",
    effect:
      "［クラスボーナス］あなたのチャンピオンは、それの上のエンライトカウンター3個につき、＋1レベルを得る。*（この効果は、あなたのチャンピオンのクラスがこのカードのクラスと一致する場合のみ適用する。）*",
  },
  ...
  "distort-reality": {
    name: "現実の歪曲",
    effect:
      "［アリスボーナス］あなたのデッキのすべてのカードをあなたの墓地に置く。その後、あなたの墓地からリザーブコストの合計が30以下になる好きな数のスペクターカードを戦場に出す。それらはそれぞれエフェメラルになる。\n\n" +
      "［アリスボーナス］エフェメレート — (15)",
  },
  ...
  "eternal-magistrate": {
    ...
    effect:
      ...
      "「永遠の執政官」がインビュー状態であるかぎり、対戦相手のマテリアライズフェイズでないかぎり、そのマテリアルデッキからカードは離れられない。",
  },
  ...
  "expel-the-departed": {
    ...
    effect:
      ...
      "最大1つの対象のファンタジアを破壊する。あなたが運命石または運命縛りのオブジェクトを2つ以上コントロールしている場合、カードを1枚引く。",
  },
  ...
  "haniel-archangel-of-spectra": {
    name: "ハニエル、スペクトラの大天使",
    effect:
      "ラクサム＆アンブラ・インビュー3 *（あなたはこのカードを起動する際、リザーブしたすべてのカードを公開してよい。そのうち少なくとも3枚がラクサムまたはアンブラエレメントの場合、このカードはインビュー状態になる。）*\n\n" +
  ...
  "harness-lightning": {
    name: "稲妻の掌握",
    effect:
      "あなたがアーケインエレメントの神獣アライをコントロールしているかぎり、あなたはこのカードを起動する際、そのエレメント条件を無視する。\n\n" +
      "1つ選ぶ——\n" +
  ...
  "heartsong-reclamation": {
    name: "ハートソングの奪還",
    effect:
      "あなたがコントロールしていないすべてのレガリアを破壊する。ターン終了時まで、あなたがコントロールする動物または獣のアライはクリーヴを得る。\n\n" +
      "［シルヴィボーナス］あなたがコントロールする各動物または獣のアライにバフカウンターを5個置く。",
  },
  ...
  "nox-final-release": {
    ...
    effect:
      ...
      "登場時：「ノックス、最後の解放」を、あなたがコントロールする装填されていない銃武器に装填する。\n\n" +
  ...
  "raziel-archangel-of-libra": {
    name: "ラジエル、天秤の大天使",
    effect:
      "アーケイン＆アストラ・インビュー3 *（あなたはこのカードを起動する際、リザーブしたすべてのカードを公開してよい。そのうち少なくとも3枚がアーケインまたはアストラエレメントの場合、このカードはインビュー状態になる。）*\n\n" +
  ...
  "sanctum-of-esoteric-truth": {
    name: "秘奥の聖域",
    effect:
      "あなたのチャンピオンがレベルアップするたび、あなたは手札またはメモリーから2枚をデッキの一番下に置いてよい。そうしたなら、カードを2枚引く。",
  },
  ...
  "solomon-master-of-elements": {
    name: "ソロモン、元素の支配者",
    effect:
      "登場時：あなたは手札とメモリーのすべてのカードを捨ててよい。そうしたなら、「アーケインの視」「アストラの視」「クラックスの視」「エクシアの視」「ラクサムの視」「ネオスの視」「テラの視」「アンブラの視」のカードを1枚ずつ生成し、それらをあなたのメモリーに置く。このゲームの残りの間、あなたが起動する、生成したカードのいずれかと同じ名前のカードのエレメント条件を無視する。",
  },
  ...
  "spellward-scepter": {
    ...
    effect:
      ...
      "レスト、「呪除けの笏」を追放する：このターン、あなたが起動する次のカードの起動は**ネゲート**されない。",
  },
  ...
  "spirit-blade-retribution": {
    ...
    effect:
      ...
      "クリーヴ\n\n" +
      "［ロレインボーナス］「スピリットブレード：報復」は＋Xパワーを得る。Xはあなたの追放領域にあるアライ・アタック・武器の各カードのパワーの合計。",
  },
