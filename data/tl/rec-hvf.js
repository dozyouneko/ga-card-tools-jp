...
window.GA_I18N.cards = Object.assign(window.GA_I18N.cards || {}, {
  ...
  "fated-keepsake": {
    ...
    effect:
      "**登場時：** カードを1枚引く。\n\n" +
      "[グオ・ジアボーナス] あなたが運命石または運命縛りのオブジェクトを合計3つ以上コントロールしているときに、あなたのチャンピオンが7点以上のダメージを受ける場合、そのダメージのうち6点を除くすべてを軽減する。",
  },
  ...
  "fatestone-of-revelations": {
    name: "啓示の運命石",
    effect:
      "**登場時：** あなたの手札またはメモリーから、運命石または運命縛りのカードを2枚公開してよい。そうした場合、カードを1枚引く。\n\n" +
  ...
  "lavaplume-fatestone": {
    ...
    effect:
      ...
      "**登場時：** スペルとして、対象のユニットに**X**点の軽減不能ダメージを与える。**X**は、あなたがコントロールする他の運命石または運命縛りのオブジェクトの数。\n\n" +
