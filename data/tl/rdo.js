...
window.GA_I18N.cards = Object.assign(window.GA_I18N.cards || {}, {
  ...
  "accelerate": {
    name: "アクセラレート",
    effect:
      "このターン、あなたが次に起動するカードはファスト・アクティベーションを持つかのように起動できる。\n\n" +
      "カードを1枚あなたのメモリーに引く。",
  },
  ...
  "advent-of-the-stormcaller": {
    ...
    effect:
      ...
      "あなたのデッキの上からLV枚を公開する。その中から任意の枚数のアーケインエレメントのカードを追放してよい。この方法で追放したカード1枚につき、ユニット1体を選び、それに2ダメージを与える。公開された残りのカードを好きな順でデッキの上または下に置く。",
  },
  ...
  "alchemists-cauldron": {
    name: "錬金術師の大釜",
    effect:
      "[アリサナボーナス] (3)、「錬金術師の大釜」を追放する：ギャザーを2回行う。以後このゲームの間、あなたが起動する非アドバンスドエレメントのポーション・カードのエレメント要件を無視する。",
  },
  ...
  "angel-attendant": {
    name: "天使の従者",
    effect:
      "アドバンスド・インビュー1 *（このカードを起動する際にリザーブされたカードをすべて公開してよい。その中にアドバンスドエレメントが1枚以上あれば、このカードはインビュー状態になる。）*\n\n" +
  ...
  "angelic-vanguard": {
    name: "天使の先鋒",
    effect:
      "アドバンスド・インビュー2 *（このカードを起動する際にリザーブされたカードをすべて公開してよい。その中にアドバンスドエレメントが2枚以上あれば、このカードはインビュー状態になる。）*\n\n" +
      "「天使の先鋒」がインビュー状態である限り、インターセプトとリトルト2を持つ。",
  },
  ...
  "apothecarys-harvest": {
    name: "薬師の収穫",
    effect:
      "*（エグザルテッド ― このエレメントは、あなたが他のアドバンスドエレメントを有効にしている限り、あなたにとって有効になる。）*\n\n" +
      "[アリサナボーナス] ファスト・アクティベーション\n\n" +
  ...
  "arcane-elemental": {
    name: "アーケインのエレメンタル",
    effect:
      "[クラスボーナス] このカードの起動コストは、あなたの追放領域にあるアーケインエレメントのカード1枚につき1少なくなる。\n\n" +
      "プライド7 *（このアライは、あなたのチャンピオンがレベル7以上でない限りあなたに従わない。）*\n\n" +
      "攻撃時：次のエンドフェイズの開始時に、「アーケインのエレメンタル」を追放する。",
  },
  ...
  "arthur-young-heir": {
    name: "アーサー、若き継承者",
    effect:
      "登場時：あなたは「アーサー」をレストしてよい。そうした場合、「アーサー」は次のあなたのターンの開始時までイモータリティを得る。*（イモータリティを持つユニットは死亡しない。）*\n\n" +
  ...
  "artificers-opus": {
    ...
    effect:
      "[クラスボーナス] エフィシェンシー *（このカードの起動コストがLV少なくなる。）*\n\n" +
      "「工匠の大作」はレスト状態で場に出る。\n\n" +
      "クリーヴ *（このアライは、選んだ対戦相手がコントロールするすべてのユニットを攻撃する。その攻撃はインターセプトされない。）*",
  },
  ...
  "avatar-of-byakko": {
    ...
    effect:
      ...
      "[グオ・ジアボーナス] (2)、「白虎の化身」をサクリファイスする：あなたのチャンピオンにクエストカウンターを2個置く。その後、あなたのマテリアルデッキまたは追放領域から「Fabled Emerald Fatestone」という名前のカードを場に出してよい。",
  },
  ...
  "avatar-of-gaia": {
    name: "ガイアの化身",
    effect:
      "アライリンク *（このオブジェクトは対象のアライにリンクした状態で場に出る。リンクが切れた場合、このオブジェクトをサクリファイスする。）*\n\n" +
      "[クラスボーナス] プリザーブ\n\n" +
  ...
  "avatar-of-genbu": {
    ...
    effect:
      ...
      "[グオ・ジアボーナス] (2)、「玄武の化身」をサクリファイスする：あなたのチャンピオンにクエストカウンターを2個置く。その後、あなたのマテリアルデッキまたは追放領域から「Fabled Sapphire Fatestone」という名前のカードを場に出してよい。",
  },
  ...
  "avatar-of-suzaku": {
    ...
    effect:
      ...
      "[グオ・ジアボーナス] (2)、「朱雀の化身」をサクリファイスする：あなたのチャンピオンにクエストカウンターを2個置く。その後、あなたのマテリアルデッキまたは追放領域から「Fabled Ruby Fatestone」という名前のカードを場に出してよい。",
  },
  ...
  "bedivere-woodland-overseer": {
    ...
    effect:
      ...
      "[クラスボーナス][レベル3以上] 死亡時：あなたがコントロールする各アニマルまたはビースト・アライにバフカウンターを1個ずつ置く。",
  },
  ...
  "black-ice-spellweaver": {
    ...
    effect:
      ...
      "「黒氷の呪織り」をサクリファイスする：ターン終了時まで、対象のユニットの攻撃は-3パワーを得る。",
  },
  ...
  "blanche-sheltering-saint": {
    name: "ブランシュ、庇護の聖女",
    effect:
      "[レベル2以上] ファスト・アクティベーション *（このカードを高速で起動してよい。）*\n\n" +
  ...
  "blightroot": {
    name: "ブライトルート",
    effect: "「ブライトルート」をサクリファイスする：ターン終了時まで、あなたのチャンピオンは+1レベルを得る。",
  },
  ...
  "cauterizing-seraphim": {
    name: "焼灼のセラフィム",
    effect:
      "アドバンスド・インビューX *（このカードを起動する際にリザーブされたカードをすべて公開してよい。その中にアドバンスドエレメントがX枚以上あれば、このカードはインビュー状態になる。）*\n\n" +
  ...
  "combustible-potion": {
    name: "可燃性ポーション",
    effect:
      "ブリュー ― ハーブ2枚 *（このカードのリザーブコストを支払う代わりに、記載されたオブジェクトをサクリファイスしてよい。）*\n\n" +
      "登場時：「可燃性ポーション」がブリューされていたなら、カードを2枚引き、カードを1枚捨てる。\n\n" +
      "「可燃性ポーション」をサクリファイスする：対象のユニットに2ダメージを与える。",
  },
  ...
  "crux-sight": {
    name: "クラックス・サイト",
    effect:
      "このカードを起動するための追加コストとして、あなたは(2)を支払ってよい。そうした場合、このカードは解決時に追放され、「あなたの墓地からクラックスエレメントのカードを1枚手札に戻す。」を得る。\n\n" +
      "カードを1枚引く。",
  },
  ...
  "dawn-of-ashes": {
    name: "灰燼の夜明け",
    effect:
      "アップキープ ― あなたのリコレクションフェイズの開始時に、あなたのメモリーからランダムにカードを1枚公開する。そのカードがノームエレメントでないなら、「灰燼の夜明け」をサクリファイスする。\n\n" +
  ...
  "decaying-reproach": {
    name: "朽ちゆく叱責",
    effect:
      "このカードを起動するための追加コストとして、あなたがコントロールしていないオブジェクトからウィザーカウンターを最大4個取り除く。\n\n" +
      "対象のユニットに3＋X点のダメージを与える。Xは取り除いたウィザーカウンターの数の2倍。\n\n" +
  ...
  "discover-the-divine": {
    name: "神性の発見",
    effect:
      "あなたのチャンピオンからエンライトカウンターを4個取り除いてよい。そうしたなら、あなたのチャンピオンをレベルアップする。*（あなたのチャンピオンは、マテリアライズコストを無視して、マテリアルデッキから適合するチャンピオンカードにレベルアップする。）*",
  },
  ...
  "displace": {
    ...
    effect:
      ...
      "［クラスボーナス］あなたのチャンピオンにエンライトカウンターを1個置く。",
  },
  ...
  "essence-crucible": {
    ...
    effect:
      "登場時：カードを1枚引く。\n\n" +
      "［アリサナボーナス］あなたがカードをブリューするたび、「エッセンスのるつぼ」にリファインメントカウンターを1個置く。\n\n" +
      "あなたがコントロールするスペルの発生源が1体以上のユニットにダメージを与える場合、代わりにそれはそのダメージにX点を加えたダメージを与える。Xは「エッセンスのるつぼ」上のリファインメントカウンターの数。",
  },
  ...
  "flame-sweep": {
    name: "炎の一掃",
    effect:
      "クリーヴ *（選んだ対戦相手がコントロールするすべてのユニットを攻撃する。この攻撃はインターセプトされない。）*\n\n" +
  ...
  "focal-intensity": {
    ...
    effect:
      "対象のユニットに1点のダメージを与える。\n\n" +
      "［マーリンボーナス］あなたの「フラクチャード・メモリーズ」からシーンカウンターを2個取り除いてよい。そうしたなら、あなたのチャンピオンにプレパレーションカウンターを2個置く。",
  },
  ...
  "fount-seraphim": {
    name: "泉のセラフィム",
    effect:
      "アドバンスド・インビュー2 *（あなたはこのカードを起動する際、リザーブしたすべてのカードを公開してよい。そのうち少なくとも2枚がアドバンスドエレメントの場合、このカードはインビュー状態になる。）*\n\n" +
      "タウント\n\n" +
  ...
  "fractal-of-duplication": {
    ...
    effect:
      ...
      "リザーブ可能 *（リザーブコストを支払う際、あなたはこのオブジェクトをレストしてそのコストの1分を支払ってよい。）*",
  },
  ...
  "fracturize": {
    name: "フラクチャライズ",
    effect:
      "対象のアイテムまたは武器は、リザーブ可能を持つクレリック・フラクタルのファンタジアになり、他のすべての能力を失う。*（この効果は無期限に続く。）*\n\n" +
      "フローティングメモリー",
  },
  ...
  "frostbind": {
    name: "霜縛り",
    effect:
      "そのコントローラーが(2)を支払わないかぎり、対象のカードの起動を**ネゲート**する。この方法で起動を**ネゲート**したカードを追放する。",
  },
  ...
  "fulminating-storm": {
    name: "雷鳴の嵐",
    effect:
      "あなたのチャンピオンからエンライトカウンターを最大9個取り除く。あなたがコントロールしていない各チャンピオンにX点のダメージを与える。Xはこの方法で取り除いたカウンターの数。\n\n" +
      "［クラスボーナス］この方法で取り除いたエンライトカウンター3個につき、カードを1枚引く。",
  },
  ...
  "glacial-binding": {
    ...
    effect:
      ...
      "そのコントローラーが(3)を支払わないかぎり、対象のカードの起動を**ネゲート**する。この方法で起動を**ネゲート**したカードを追放する。",
  },
  ...
  "hoarfrost-hold": {
    name: "白霜の砦",
    effect:
      "［クラスボーナス］登場時：あなたの手札またはメモリーからスートスペルカードを好きな数追放する。この方法で追放した各カードにつき、「白霜の砦」に霜カウンターを1個置く。\n\n" +
  ...
  "innervate-agility": {
    name: "活力の敏捷",
    effect:
      "このカードを起動するための追加コストとして、あなたのチャンピオンをデレベルし、リカバー5する。*（デレベルするには、そのリネージュの一番上のカードをオーナーのマテリアルデッキに戻す。）*\n\n" +
  ...
  "inspiring-aethercharge": {
    ...
    effect:
      ...
      "あなたは「鼓舞のエーテルチャージ」を、あなたがコントロールするエーテルウィング武器に装填してよい。",
  },
  ...
  "lotor-trinket": {
    name: "ロトルの装飾品",
    effect:
      "［クラスボーナス］対戦相手の墓地にカードが1枚もないかぎり、あなたがコントロールするラクーン・アライは＋1パワーを得る。\n\n" +
      "登場時：スカベンジ6（ラクーン・アライ）。",
  },
  ...
  "memorite-obelith": {
    ...
    effect:
      ...
      "退場時：あなたの「フラクチャード・メモリーズ」にシーンカウンターをX個置く。Xは「メモライト・オベリス」の上にあったシーンカウンターの数。",
  },
  ...
  "otherworldly-possessions": {
    name: "異界の憑依",
    effect:
      "あなたがコントロールするオブジェクトおよびあなたの墓地のカードの中の異なるリザーブコスト1つにつき、あなたのチャンピオンにエンライトカウンターを1個置く。",
  },
  ...
  "photic-blade": {
    name: "光子の刃",
    effect:
      "「光子の刃」は、それの上のリファインメントカウンター1個につき、＋1パワーを得る。\n\n" +
      "［クラスボーナス］あなたがリカバーするたび、「光子の刃」にリファインメントカウンターを1個置く。",
  },
  ...
  "protector-raccoon": {
    name: "守護者アライグマ",
    effect:
      "ファスト・アクティベーション *（あなたはこのカードをファストスピードで起動してよい。）*\n\n" +
  ...
  "recurring-aethercharge": {
    name: "回帰するエーテルチャージ",
    effect:
      "あなたは「回帰するエーテルチャージ」を、あなたがコントロールするエーテルウィング武器に装填してよい。\n\n" +
      "［クラスボーナス］(3)：このカードを墓地から、あなたがコントロールするエーテルウィング武器に装填する。",
  },
  ...
  "redirect-orbit": {
    name: "軌道の変更",
    effect:
      "あなたの手札またはメモリーから好きな数のカードをあなたのデッキに切り混ぜる。その後、その枚数のカードをあなたのメモリーに引く。",
  },
  ...
  "reversals-polarity": {
    name: "反転の極性",
    effect:
      "あなたがコントロールするアーケインエレメントのカードの起動が**ネゲート**されるたび、対象のチャンピオンにX点のダメージを与える。Xはそのカードのリザーブコスト。",
  },
  ...
  "royal-line-defense": {
    ...
    effect:
      ...
      "・チェスマンアライが攻撃している場合、対象のカードの起動を**ネゲート**する。",
  },
  ...
  "saprotrophy": {
    ...
    effect:
      ...
      "［ダオ・チャンボーナス］対戦相手がコントロールするオブジェクトは、ウィザーカウンターを1個追加で乗せて戦場に出る。",
  },
  ...
  "scientific-discoveries": {
    name: "科学的発見",
    effect:
      "グリンプス3する。その後、あなたのチャンピオンからエンライトカウンターを2個取り除いてよい。そうしたなら、カードを1枚あなたのメモリーに引く。",
  },
  ...
  "scorching-knowledge": {
    ...
    effect:
      ...
      "［ライボーナス］あなたのチャンピオンからエンライトカウンターを1個取り除いてよい。そうしたなら、エンパワー3する。",
  },
  ...
  "shock-therapy": {
    name: "ショック療法",
    effect:
      "［クラスボーナス］［エレメントボーナス］このカードがあなたのメモリーから追放されるたび、あなたのチャンピオンにエンライトカウンターを1個置く。\n\n" +
      "対象のアライに、あなたのチャンピオン上のエンライトカウンターの数に等しい量のダメージを与える。",
  },
  ...
  "silvergale-monstrositys-call": {
    ...
    effect:
      "プレパレーション2\n\n" +
      "メモライト・オベリストークンを1つ召喚する。「シルバーゲイルの怪物の呼び声」がプレパレーションされていた場合、あなたの「フラクチャード・メモリーズ」から好きな数のシーンカウンターを、あなたがコントロールする「メモライト・オベリス」という名前の好きな数のアライに移す。",
  },
  ...
  "spirit-blade-ensoul": {
    name: "スピリットブレード：魂込め",
    effect:
      "あなたの追放領域またはマテリアルデッキからメモリーコスト1以下の剣武器カードを好きな数選び、それらを戦場に出す。ターン終了時まで、あなたがコントロールする剣武器はアライであるかのように攻撃できる。あなたの次のエンドフェイズの開始時に、あなたがコントロールするすべての剣武器をサクリファイスする。",
  },
  ...
  "spurred-gallop": {
    name: "拍車の疾走",
    effect:
      "このターン、あなたが起動する次の馬アライカードは、ファスト・アクティベーションを持つかのように起動できる。\n\n" +
  ...
  "stifling-aethercharge": {
    name: "抑圧のエーテルチャージ",
    effect:
      "対象のアライのすべての登場時誘発を**ネゲート**する。\n\n" +
      "あなたは「抑圧のエーテルチャージ」を、あなたがコントロールするエーテルウィング武器に装填してよい。",
  },
  ...
  "stifling-gyre": {
    ...
    effect:
      ...
      "登場時：カードを1枚あなたのメモリーに引く。\n\n" +
      "選ばれた名前を持つアライの登場時能力が誘発するたび、そのコントローラーが(4)を支払わないかぎり、その誘発を**ネゲート**する。",
  },
  ...
  "surging-obstruction": {
    ...
    effect:
      ...
      "そのコントローラーが(1)を支払わないかぎり、対象のカードの起動を**ネゲート**する。そのカードのリザーブコストが奇数の場合、代わりにそのコントローラーが(3)を支払わないかぎり、その起動を**ネゲート**する。*（0は偶数とみなす。）*",
  },
  ...
  "umbra-sight": {
    ...
    effect:
      "カードを1枚引く。\n\n" +
      "あなたはカードを1枚あなたのメモリーに引き、「アンブラ・サイト」をあなたのチャンピオンのリネージュの一番下に置いてよい。そうしたとき、あなたのチャンピオンのリネージュにある呪いカード1枚につき、あなたのチャンピオンに2点の軽減不能のダメージを与える。",
  },
  ...
  "vertus-gaias-roar": {
    ...
    effect:
      ...
      "［クラスボーナス］登場時：ターン終了時まで、あなたがコントロールするアライは、あなたの墓地にある動物または獣のアライカード1枚につき＋1パワーを得る。",
  },
  ...
  "windmill-engineer": {
    name: "風車の技師",
    effect:
      "インビュー2 *（あなたはこのカードを起動する際、リザーブしたすべてのカードを公開してよい。そのうち少なくとも2枚が風エレメントの場合、このカードはインビュー状態になる。）*\n\n" +
  ...
  "zinn-volnia-abbess": {
    ...
    effect:
      "［アリサナボーナス］あなたが1つ以上のシルバーシャインまたはフレイシアのトークンを召喚する場合、代わりにその数のヴォルニアトークンを召喚する。",
  },
});
