...
window.GA_I18N.cards = Object.assign(window.GA_I18N.cards || {}, {
  ...
  "alchemists-cauldron": {
    name: "錬金術師の大釜",
    effect:
      "[アリサンナボーナス] (3)、「錬金術師の大釜」を追放する：ギャザーを2回行う。以後このゲームの間、あなたが起動する非上位エレメントのポーション・カードのエレメント要件を無視する。",
  },
  ...
  "blights-ring": {
    name: "枯朽の指輪",
    effect:
      "(4)、レスト：カードを1枚あなたのメモリーに引く。その後、「枯朽の指輪」を対象のチャンピオンのリネージの一番下に置く。\n\n" +
  ...
  "classical-opening": {
    name: "定跡の初手",
    effect:
      "号令：チェスマン *（あなたがコントロールするチェスマン・アライ1体がこの攻撃を行う。）*\n\n" +
      "エフェメレート ― (3)",
  },
  ...
  "decaying-reproach": {
    ...
    effect:
      ...
      "［貂蝉ボーナス］(2)、このカードを手札から捨てる：カードを1枚あなたのメモリーに引き、2リカバーする。",
  },
  ...
  "devised-conspiracy": {
    ...
    effect:
      "［トリスタンボーナス］プリペア2\n\n" +
      "このターン、あなたのチャンピオンの次の攻撃は＋2パワーを得る。「仕組まれた陰謀」がプリペアされていた場合、ターン終了時まで、あなたのチャンピオンおよびあなたがコントロールする「不吉な影」という名前のアライは「チャンピオンヒット時：そのプレイヤーのデッキの一番上のカードを裏向きに追放する。それが追放されているかぎり、あなたはそのエレメント条件を無視してそれをプレイしてよい。」を得る。",
  },
  ...
  "dewy-slime": {
    ...
    effect:
      ...
      "登場時：あなたの墓地からフローティングメモリーを持つカードを1枚追放してよい。そうしたなら、カードを1枚引き、2リカバーする。",
  },
  ...
  "elucidate-plans": {
    name: "計画の解明",
    effect:
      "あなたのチャンピオンにプリペアレーションカウンターを2個置く。\n\n" +
      "［クラスボーナス］［エレメントボーナス］あなたが自分のメモリーからこのカードを公開するたび、あなたのチャンピオンにプリペアレーションカウンターを1個置く。",
  },
  ...
  "ensnaring-fumes": {
    name: "からめとる霧",
    effect:
      "このカードのリザーブコストを支払う代わりに、あなたのチャンピオンからプリペアレーションカウンターを3個取り除いてよい。\n\n" +
      "すべてのアライをオーナーの手札に戻す。\n\n" +
      "［クラスボーナス］フローティングメモリー",
  },
  ...
  "essence-crucible": {
    ...
    effect:
      "登場時：カードを1枚引く。\n\n" +
      "［アリサンナボーナス］あなたがカードをブリューするたび、「エッセンスのるつぼ」に精製カウンターを1個置く。\n\n" +
  ...
  "everlonging-thorns": {
    ...
    effect:
      ...
      "［孔明ボーナス］「永久の茨」がエンパワーされている場合、それをプリザーブしてオーナーのマテリアルデッキに置く。",
  },
  ...
  "fast-cure": {
    name: "速効治療",
    effect:
      "対象の対戦相手のインフルエンスがあなたのものより大きい場合、4リカバーする。*（プレイヤーのインフルエンスは、その手札とメモリーのカードの合計枚数に等しい。）*\n\n" +
      "フローティングメモリー",
  },
  ...
  "find-recipe": {
    name: "レシピの発見",
    effect:
      "ポーションカードを求めてスカベンジ6する。*（ある量をスカベンジするには、その枚数のカードを公開するか指定されたカードを公開するまで、デッキの一番上からカードを公開する。指定されたカードを手札に入れ、残りをランダムな順番でデッキの一番下に置く。）*",
  },
  ...
  "flourishing-restoration": {
    name: "旺盛な回復",
    effect:
      "［貂蝉ボーナス］あなたはこのカードを起動する際、そのエレメント条件を無視してよい。そうしたなら、それは起動コストが2多くなる。\n\n" +
      "3リカバーする。その後、あなたがコントロールしていない最大2体のアライにつき、再び3リカバーする。",
  },
  ...
  "focal-intensity": {
    ...
    effect:
      "対象のユニットに1点のダメージを与える。\n\n" +
      "［マーリンボーナス］あなたの「砕けた記憶」からシーンカウンターを2個取り除いてよい。そうしたなら、あなたのチャンピオンにプリペアレーションカウンターを2個置く。",
  },
  ...
  "fraysia": {
    name: "フレイシア",
    effect: "「フレイシア」をサクリファイスする：1リカバーする。",
  },
  ...
  "glacier-remnants": {
    name: "氷河の残滓",
    effect:
      "あなたのリコレクションフェイズの開始時に、「氷河の残滓」から耐久カウンターを最大2個取り除く。その後、Xリカバーする。Xはこの方法で取り除いたカウンターの数。\n\n" +
      "フローティングメモリー",
  },
  ...
  "heirloom-of-spectra": {
    ...
    effect:
      ...
      "・チャンピオンのリニージにある呪いカードを1枚選び、それを追放する。\n\n" +
  ...
  "hexbound-blade": {
    ...
    effect:
      ...
      "［トリスタンボーナス］ヒット時：「呪縛の刃」を対象のチャンピオンのリニージの一番下に置く。\n\n" +
  ...
  "ignited-stab": {
    ...
    effect:
      ...
      "［クラスボーナス］攻撃時：「燃え上がる刺突」がプリペアされていた場合、それは＋2パワーを得る。*（この効果は、あなたのチャンピオンのクラスがこのカードのクラスと一致する場合のみ適用する。）*",
  },
  ...
  "imperial-countermeasure": { name: "", effect: "" },
  ...
  "innervate-knowledge": { name: "", effect: "" },
  ...
  "inspiring-aethercharge": { name: "", effect: "" },
  ...
  "ionized-asceticism": { name: "", effect: "" },
  ...
  "iridescent-resurgence": { name: "", effect: "" },
  ...
  "iron-halo-forcefield-node": { name: "", effect: "" },
  ...
  "kraal-stonescale-tyrant": { name: "", effect: "" },
  ...
  "lancelot-goliath-of-aesa": { name: "", effect: "" },
  ...
  "liturgy-of-corruption": { name: "", effect: "" },
  ...
  "lunete-frostbinder-priest": { name: "", effect: "" },
  ...
  "meiren-of-verdancy": { name: "", effect: "" },
  ...
  "nia-mistveiled-scout": { name: "", effect: "" },
  ...
  "nimble-court-assassin": { name: "", effect: "" },
  ...
  "nimue-cursed-touch": { name: "", effect: "" },
  ...
  "nuriel-seraphic-paladin": { name: "", effect: "" },
  ...
  "otherworldly-possessions": { name: "", effect: "" },
  ...
  "parcenet-royal-maid": { name: "", effect: "" },
  ...
  "piquant-shieldbearer": { name: "", effect: "" },
  ...
  "potion-infusion-animate": { name: "", effect: "" },
  ...
  "potion-infusion-volatility": { name: "", effect: "" },
  ...
  "prismatic-sanctuary": { name: "", effect: "" },
  ...
  "proto-archive-scout": { name: "", effect: "" },
  ...
  "radiant-origin-of-assassin": { name: "", effect: "" },
  ...
  "radiant-origin-of-cleric": { name: "", effect: "" },
  ...
  "radiant-origin-of-guardian": { name: "", effect: "" },
  ...
  "radiant-origin-of-mage": { name: "", effect: "" },
  ...
  "radiant-origin-of-ranger": { name: "", effect: "" },
  ...
  "radiant-origin-of-tamer": { name: "", effect: "" },
  ...
  "radiant-origin-of-warrior": { name: "", effect: "" },
  ...
  "rapid-deployment-nexus": { name: "", effect: "" },
  ...
  "recurring-aethercharge": { name: "", effect: "" },
  ...
  "reversals-polarity": { name: "", effect: "" },
  ...
  "royal-line-defense": { name: "", effect: "" },
  ...
  "sabela-gossamer-penance": { name: "", effect: "" },
  ...
  "sanctified-paladin": { name: "", effect: "" },
  ...
  "scientific-discoveries": { name: "", effect: "" },
  ...
  "scorching-knowledge": { name: "", effect: "" },
  ...
  "seething-intercession": { name: "", effect: "" },
  ...
  "shaded-doppelganger": { name: "", effect: "" },
  ...
  "shademist-priestess": { name: "", effect: "" },
  ...
  "sinister-composure": { name: "", effect: "" },
