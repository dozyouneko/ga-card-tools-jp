...
window.GA_I18N.cards = Object.assign(window.GA_I18N.cards || {}, {
  ...
  "angel-attendant": {
    name: "天使の従者",
    effect:
      "アドバンスド・インビュー1 *（このカードを起動する際にリザーブされたカードをすべて公開してよい。その中に上位エレメントが1枚以上あれば、このカードはインビュー状態になる。）*\n\n" +
  ...
  "angelic-vanguard": {
    name: "天使の先鋒",
    effect:
      "アドバンスド・インビュー2 *（このカードを起動する際にリザーブされたカードをすべて公開してよい。その中に上位エレメントが2枚以上あれば、このカードはインビュー状態になる。）*\n\n" +
  ...
  "apothecarys-harvest": {
    name: "薬師の収穫",
    effect:
      "*（エグザルテッド ― このエレメントは、あなたが他の上位エレメントを有効にしている限り、あなたにとって有効になる。）*\n\n" +
  ...
  "cauterizing-seraphim": {
    name: "焼灼のセラフィム",
    effect:
      "アドバンスド・インビューX *（このカードを起動する際にリザーブされたカードをすべて公開してよい。その中に上位エレメントがX枚以上あれば、このカードはインビュー状態になる。）*\n\n" +
  ...
  "innervate-agility": {
    name: "活力の敏捷",
    effect:
      "このカードを起動するための追加コストとして、あなたのチャンピオンをデレベルし、リカバー5する。*（デレベルとはチャンピオンのレベルを下げることを指し、チャンピオンの一番上のカードを所有者のマテリアルデッキに戻す。）*\n\n" +
