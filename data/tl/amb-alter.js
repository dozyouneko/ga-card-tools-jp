...
window.GA_I18N.cards = Object.assign(window.GA_I18N.cards || {}, {
  ...
  "everflame-staff": {
    name: "永炎の杖",
    effect:
      "あなたがコントロールする火エレメントのスペルの発生源がダメージを与えるたび、「永炎の杖」にリファインメントカウンターを1個置く。\n\n" +
      "［クラスボーナス］「永炎の杖」を追放する：スペルとして、対象のチャンピオンに4点のダメージを与える。この能力は、「永炎の杖」の上にリファインメントカウンターが3個以上ある場合のみ起動する。",
  },
  ...
  "gustguard-bastion": {
    name: "突風防御の砦",
    effect:
      "［クラスボーナス］ファスト・アクティベーション *（あなたはこのカードをファストスピードで起動してよい。）*\n\n" +
  ...
  "herd-of-the-hearth": {
    name: "炉辺の群れ",
    effect:
      "ターン終了時まで、あなたがコントロールする動物および獣のアライは＋1パワーを得る。このうち馬アライはさらに「攻撃時：カードを1枚引き、その後カードを1枚捨てる。」を得る。\n\n" +
      "［クラスボーナス］フローティングメモリー",
  },
