...
window.GA_I18N.cards = Object.assign(window.GA_I18N.cards || {}, {
  ...
  "ciel-omenbringer": {
    ...
    effect:
      ...
      "リネージ解放 ― あなたは自分のオーメンを1つ起動してよい。この能力は、あなたがオーメンを6つ以上持っている場合にのみ起動できる。",
  },
  ...
  "reverse-affliction": {
    name: "苦痛の反転",
    effect:
      "あなたのチャンピオンのリネージからカース・カードを1枚追放する。あなたがそのカードのオーナーなら、それにオーメンカウンターを1個置く。",
  },
  ...
  "sinistre-stab": {
    name: "シニストル・スタブ",
    effect:
      "ヒット時：あなたがオーメンを5つ以上持っているなら、「シニストル・スタブ」をヒットしたチャンピオンのリネージの一番下に置いてもよい。そうでなければ、「シニストル・スタブ」をあなたのチャンピオンのリネージの一番下に置く。\n\n" +
      "継承効果 ― このオブジェクトは-3ライフを得る。*（このカードがリネージの一部である限り、チャンピオンはこの能力を持つ。）*",
  },
  ...
  "umbra-sight": {
    ...
    effect:
      "カードを1枚引く。\n\n" +
      "あなたはカードを1枚あなたのメモリーに引き、「アンブラ・サイト」をあなたのチャンピオンのリネージの一番下に置いてもよい。そうしたとき、あなたのチャンピオンのリネージにあるカース・カード1枚につき、あなたのチャンピオンに2点の軽減不能ダメージを与える。",
  },
