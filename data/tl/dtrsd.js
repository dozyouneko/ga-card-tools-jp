...
window.GA_I18N.cards = Object.assign(window.GA_I18N.cards || {}, {
  ...
  "aetheric-calibration": {
    ...
    effect:
      ...
      "あなたがコントロールするエーテルウィング武器に「エーテル調整」を装填してもよい。",
  },
  ...
  "ciel-omenbringer": {
    ...
    effect:
      ...
      "リネージュ・リリース ― あなたは自分のオーメンを1つ起動してよい。この能力は、あなたがオーメンを6つ以上持っている場合にのみ起動できる。",
  },
  ...
  "diana-judgments-arrow": {
    ...
    effect:
      "ダイアナ・リネージュ\n\n" +
      "登場時：あなたの手札またはメモリーから、エーテルチャージ・カードを最大2枚、あなたがコントロールするエーテルウィング武器に装填する。この方法で装填したカード1枚につき、カードを1枚あなたのメモリーに引く。\n\n" +
      "継承効果 ― レンジド1",
  },
  ...
  "diana-moonpiercer": {
    ...
    effect:
      ...
      "・「ダイアナ」を対象とする各カードの起動を、そのコントローラーが(2)を支払わない限り**ネゲート**する。その後、「ダイアナ」が防御しているなら、攻撃側のプレイヤーが(2)を支払わない限り戦闘フェイズを終了する。\n" +
      "・グリンプス2。",
  },
  ...
  "guided-starlight": {
    ...
    effect:
      "[エレメントボーナス] エーテルコーリング\n\n" +
      "このターン、あなたのチャンピオンの次の攻撃は、対戦相手が(3)を支払わない限りアンブロッカブルを得る。\n\n" +
  ...
  "overpowering-defense": {
    ...
    effect:
      ...
      "あなたがコントロールしていないすべてのカードの起動を**ネゲート**する。",
  },
  ...
  "poised-occlusion": {
    name: "静かなる遮蔽",
    effect:
      "対象のカードの起動を**ネゲート**する。この方法で起動を**ネゲート**されたカードを、そのオーナーのメモリーに置く。\n\n" +
